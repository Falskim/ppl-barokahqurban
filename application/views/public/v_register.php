        ...
        <div class="row">
            <div class="col-md-6 wow slideInLeft hidden-xs hidden-sm">
                <div class="contact_form">
                    <h3><i class="fa fa-envelope-o grd1 global-radius"></i> REGISTER AKUN</h3>
                    <form id="contactform1" class="row" method="POST" action="<?= site_url('register/validate') ?>">
            ...
            <div class="col-md-6 col-sm-12">
                <div class="big-tagline clearfix">
                    ...
                    <p class="lead">Bergabunglah Bersama Kami Sekarang Dengan Membuat Akun Baru</p>
